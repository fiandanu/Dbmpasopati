...
/**
 * AdminLTE Demo Menu with Persistent Dark Mode
 * Updated to save dark mode state in localStorage
 */
...
(function ($) {
  ...
  function initializeDarkMode() {
    var isDarkMode = localStorage.getItem("AdminLTE:DarkMode") === "true";
    if (isDarkMode) {
  ...
  var currentDarkModeState = initializeDarkMode();
  ...
  // Updated Dark Mode Checkbox with localStorage
  var $dark_mode_checkbox = $("<input />", {
    type: "checkbox",
    value: 1,
    checked: currentDarkModeState, // Use the initialized state
    class: "mr-1",
  }).on("click", function () {
    ...
    if (isChecked) {
      $("body").addClass("dark-mode");
      localStorage.setItem("AdminLTE:DarkMode", "true");
    } else {
      $("body").removeClass("dark-mode");
      localStorage.setItem("AdminLTE:DarkMode", "false");
    }
  });
  ...
  var $header_fixed_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      localStorage.setItem("AdminLTE:HeaderFixed", "true");
    } else {
      $("body").removeClass("layout-navbar-fixed");
      localStorage.setItem("AdminLTE:HeaderFixed", "false");
    }
  });
  ...
  // Initialize other settings from localStorage if needed
  function initializeOtherSettings() {
    // Header Fixed
    var isHeaderFixed = localStorage.getItem("AdminLTE:HeaderFixed") === "true";
    if (isHeaderFixed) {
      $("body").addClass("layout-navbar-fixed");
    ...
    var isSidebarCollapsed =
      localStorage.getItem("AdminLTE:SidebarCollapsed") === "true";
    if (isSidebarCollapsed) {
      $("body").addClass("sidebar-collapse");
    }

    // Footer Fixed
    var isFooterFixed = localStorage.getItem("AdminLTE:FooterFixed") === "true";
    if (isFooterFixed) {
  ...
  var $sidebar_collapsed_checkbox = $("<input />", {
    ...
    if (isChecked) {
      $("body").addClass("sidebar-collapse");
      localStorage.setItem("AdminLTE:SidebarCollapsed", "true");
      $(window).trigger("resize");
    } else {
      $("body").removeClass("sidebar-collapse");
      localStorage.setItem("AdminLTE:SidebarCollapsed", "false");
      $(window).trigger("resize");
    }
  });
  ...
  // (I'm keeping the rest of the code intact for brevity)
  ...
  var $footer_fixed_checkbox = $("<input />", {
    ...
    if (isChecked) {
      $("body").addClass("layout-footer-fixed");
      localStorage.setItem("AdminLTE:FooterFixed", "true");
    } else {
      $("body").removeClass("layout-footer-fixed");
      localStorage.setItem("AdminLTE:FooterFixed", "false");
    }
  });
  ...
  function resetAllSettings() {
    localStorage.removeItem("AdminLTE:DarkMode");
    localStorage.removeItem("AdminLTE:HeaderFixed");
    localStorage.removeItem("AdminLTE:SidebarCollapsed");
    localStorage.removeItem("AdminLTE:FooterFixed");
    location.reload();
  }
