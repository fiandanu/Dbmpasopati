...
@section('content')
                        ...
                        @if (request('table_search'))
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    <a href="{{ route('mikrotik_page.ListDataSpp') }}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <form action="{{ route('mikrotik_page.ListDataSpp') }}" method="GET">
                                    ...
                                    <tbody>
                                        @forelse ($data as $d)
                                            <tr>
                                                ...
                                                <td><strong>{{ $d->tutor_mikrotik }}</strong></td>
                                                <td>{{ $d->tanggal }}</td>
                                                <td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Apakah Anda yakin ingin menghapus file PDF untuk
                                                                    <b>{{ $d->tutor_mikrotik }}</b> di Folder
                                                                    {{ $i }}?
                                                                </p>
                                                                <p class="text-info">
    ...
    <script>
        function updateFolder(id, folder) {
            ...
            form.action = "{{ route('mikrotik_page.uploadFilePDF', [':id', ':folder']) }}"
                .replace(':id', id)
