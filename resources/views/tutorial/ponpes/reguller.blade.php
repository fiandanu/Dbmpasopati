...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <form action="{{ route('tutor_ponpes_reguller.ListDataSpp') }}" method="GET">
                                    ...
                                    <tbody>
                                        @forelse ($data as $d)
                                            <tr>
                                                ...
                                                <td><strong>{{ $d->tutor_ponpes_reguller }}</strong></td>
                                                <td>{{ $d->tanggal }}</td>
                                                <td>
                                                    @php
                                                        ...
                                                        <form
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    ...
                                                                    untuk {{ $d->tutor_ponpes_reguller }}</h5>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Apakah Anda yakin ingin menghapus file PDF untuk
                                                                    <b>{{ $d->tutor_ponpes_reguller }}</b> di Folder
                                                                    {{ $i }}?
                                                                </p>
                                                                <p class="text-info">
    ...
    <script>
        ...
        // Update action URL with the selected folder - Fixed route name untuk ponpes
