                        ...
                        @if (request('table_search'))
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    <a href="{{ route('tutor_ponpes_vtren.ListDataSpp') }}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <form action="{{ route('tutor_ponpes_vtren.ListDataSpp') }}" method="GET">
                                    ...
                                    <tbody>
                                        @forelse ($data as $d)
                                            <tr>
                                                ...
                                                <td><strong>{{ $d->tutor_ponpes_vtren }}</strong></td>
                                                <td>{{ $d->tanggal }}</td>
                                                <td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Apakah Anda yakin ingin menghapus file PDF untuk
                                                                    <b>{{ $d->tutor_ponpes_vtren }}</b> di Folder
                                                                    {{ $i }}?
                                                                </p>
                                                                <p class="text-info">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="tutor_ponpes_vtren" name="tutor_ponpes_vtren"
                                                                required>
                                                        </div>
