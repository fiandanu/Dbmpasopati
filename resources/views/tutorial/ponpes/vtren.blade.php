...
@section('content')
                ...
                <div class="row py-3 align-items-center">
                    <div class="col d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-center align-items-center gap-12">
                            ...
                            <h1 class="headline-large-32 mb-0">Tutorial Vtren</h1>
                        </div>
                                    ...
                                    <div class="modal fade" id="uploadModal{{ $d->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <form
                                                    action="{{ route('tutor_ponpes_vtren.uploadFilePDF', [$d->id, 1]) }}"
                                                                        ...
                                                                        <div class="pdf-folder-actions"
                                                                            ...
                                                                            @if ($hasFile)
                                                                                ...
                                                                                <div class="btn-group mb-3 gap-3"
                                                                                    role="group">
                                                                                    <a href="{{ route('tutor_ponpes_vtren.viewpdf', [$d->id, $i]) }}"
                                                                                        target="_blank"
                                                                                        class="view-btn-pdf"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer flex-row-reverse justify-content-between">
                                                        ...
                                                        <form
                                                            action="{{ route('tutor_ponpes_vtren.deleteFilePDF', [$d->id, $i]) }}"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body text-center align-items-center">
                                                    <ion-icon name="alert-circle-outline"
                                                        class="text-9xl text-[var(--yellow-04)]"></ion-icon>
                                                    <p class="headline-large-32">Anda Yakin?</p>
                                                    <label>Apakah Folder <b> {{ $d->tutor_ponpes_vtren }} </b>
                                                        ingin
                                                        dihapus?</label>
                                                </div>
                                                <div class="modal-footer flex-row-reverse justify-content-between">
                                                    <button type="button" class="btn-cancel-modal"
                                                        data-dismiss="modal">Batal</button>
                                                    <form
                                                        action="{{ route('tutor_ponpes_vtren.DataBasePageDestroy', $d->id) }}"
                                                        method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn-delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <form id="addForm" action="{{ route('tutor_ponpes_vtren.store') }}" method="POST">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="tutor_ponpes_vtren">Judul
                                Tutorial</label>
                            <input type="text" class="form-control" id="tutor_ponpes_vtren" name="tutor_ponpes_vtren"
                                required placeholder="Masukan Judul">
                        </div>
                        @error('tutor_ponpes_vtren')
    ...
    <script>
        $(document).ready(function() {
            ...
            window.downloadCsv = function() {
                ...
                form.method = 'GET';
                form.action = '{{ route('tutor_ponpes_vtren.export.vtren.list.csv') }}';
                form.target = '_blank';
            ...
            window.downloadPdf = function() {
                ...
                let form = document.createElement('form');
                form.method = 'GET';
                form.action = '{{ route('tutor_ponpes_vtren.export.vtren.list.pdf') }}';
                form.target = '_blank';
    ...
    <script>
        function updateFolder(id, folder) {
            ...
            form.action = "{{ route('tutor_ponpes_vtren.uploadFilePDF', [':id', ':folder']) }}"
                .replace(':id', id)
