                        ...
                        @if (request('table_search'))
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    <a href="{{ route('server_page.ListDataSpp') }}" class="btn btn-sm btn-secondary ml-2">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap" id="Table">
                                            ...
                                            <div class="modal fade" id="uploadModal{{ $d->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <form action="{{ route('server_page.uploadFilePDF', [$d->id, 1]) }}"
                                    ...
                                    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel"
                                        aria-hidden="true">
                                        <form id="addForm" action="{{ route('server_page.store') }}" method="POST">
                                            @csrf
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
...
<script>
    $(document).ready(function() {
        ...
        window.downloadCsv = function() {
            ...
            form.method = 'GET';
            form.action = '{{ route('server_page.export.server.list.csv') }}';
            form.target = '_blank';
        ...
        window.downloadPdf = function() {
            ...
            let form = document.createElement('form');
            form.method = 'GET';
            form.action = '{{ route('server_page.export.server.list.pdf') }}';
            form.target = '_blank';
