...
<div class="content-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <form action="{{ route('tutor_vpas.ListDataSpp') }}" method="GET">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    @forelse ($data as $d)
                                        <tr>
                                            ...
                                            <td><strong>{{ $d->tutor_vpas }}</strong></td>
                                            <td>{{ $d->tanggal }}</td>
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-sm btn-primary mr-1" data-toggle="modal"
                                                        data-target="#uploadModal{{ $d->id }}" title="Upload PDF">
                                        ...
                                        <div class="modal fade" id="uploadModal{{ $d->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form action="{{ route('tutor_vpas.uploadFilePDF', [$d->id, 1]) }}"
                                                        ...
                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="pdf-folder-actions"
                                                                                ...
                                                                                @if (!empty($d->$column))
                                                                                    ...
                                                                                    <div class="btn-group mb-3"
                                                                                        role="group">
                                                                                        <a href="{{ route('tutor_vpas.viewpdf', [$d->id, $i]) }}"
                                                                                            target="_blank"
                                                                                            class="btn btn-info"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file"
                                                                    ...
                                                                    id="uploaded_pdf" name="uploaded_pdf" accept=".pdf">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            ...
                                                            <form
                                                                action="{{ route('tutor_vpas.deleteFilePDF', [$d->id, $i]) }}"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-default"
                                                            data-dismiss="modal">Batal</button>
                                                        <form
                                                            action="{{ route('tutor_vpas.DataBasePageDestroy', $d->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                ...
                                <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel"
                                    aria-hidden="true">
                                    <form id="addForm" action="{{ route('tutor_vpas.store') }}" method="POST">
                                        @csrf
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    {{-- Input Nama UPT --}}
                                                    <div class="mb-3">
                                                        <label for="tutor_vpas" class="form-label">Judul
                                                            Tutorial</label>
                                                        <input type="text" class="form-control" id="tutor_vpas"
                                                            name="tutor_vpas" required>
                                                    </div>
                                                    @error('tutor_vpas')
    ...
    <script>
        function updateFolder(id, folder) {
            ...
            form.action = "{{ route('tutor_vpas.uploadFilePDF', [':id', ':folder']) }}"
                .replace(':id', id)
