                ...
                <div class="row py-3 align-items-center">
                    <div class="col d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-center align-items-center gap-12">
                            ...
                            <h1 class="headline-large-32 mb-0">Tutorial Reguler</h1>
                        </div>
                    ...
                    <div class="flex-grow-1 ml-3">
                        ...
                        <div class="small">
                            @foreach ($errors->all() as $error)
                                <div class="mb-1">Ã¢â‚¬Â¢ {{ $error }}</div>
                            @endforeach
                        </div>
                    </div>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <div class="d-flex gap-12">
                            <div class="gap-12 w-fit text-center">
                                <div class="d-flex justify-content-center align-items-center gap-12">
                                    <div class=" d-flex justify-content-center btn-searchbar column-search w-auto">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center align-items-center">
                                                            <ion-icon name="alert-circle-outline"
                                                                class="text-9xl text-[var(--yellow-04)]"></ion-icon>
                                                            <p class="headline-large-32">Anda Yakin?</p>
                                                            <label>Apakah Folder <b> {{ $d->tutor_reguller }} </b> ingin
                                                                dihapus?</label>
                                                        </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="tutor_reguller">Judul
                                                    Tutorial</label>
                                                <input type="text" class="form-control" id="tutor_reguller"
                                                    name="tutor_reguller" required placeholder="Masukan Judul">
                                            </div>
