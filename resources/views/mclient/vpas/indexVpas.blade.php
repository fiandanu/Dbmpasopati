    ...
    <div class="content-wrapper">
        ...
        {{-- <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>List Data Komplain Client VPAS</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section> --}}
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah data monitoring client VPAS di
                                                                <b>{{ $d->lokasi }}</b> ingin dihapus?
                                                            </p>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="lokasi"
                                                            name="lokasi" placeholder="Masukkan lokasi UPT" required>
                                                    </div>

                                                    {{-- <div class="mb-3">
                                                        <label for="jenis_kendala" class="form-label">Kendala VPAS</label>
                                                        <textarea class="form-control" id="jenis_kendala" name="jenis_kendala" rows="3"
                                                            placeholder="Deskripsikan kendala yang dialami"></textarea>
                                                    </div> --}}
                                                    ...
                                                    {{-- <div class="mb-3">
                                                        ...
                                                        <select class="form-control" id="jenis_kendala"
                                                            ...
                                                            @foreach ($jenisKendala as $kendala)
                                                                <option value="{{ $kendala }}">{{ $kendala }}
                                                                </option>
                                                            @endforeach
                                                            <option value="lainnya">Lainnya (tulis di detail kendala)
                                                            </option>
                                                        </select>
                                                    </div> --}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="lokasi" class="form-label">Lokasi <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" id="lokasi"
                                                                name="lokasi" value="{{ $d->lokasi }}"
                                                                placeholder="Masukkan lokasi UPT" required>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="jenis_kendala" class="form-label">Kendala
                                                                VPAS</label>
                                                            <textarea class="form-control" id="jenis_kendala" name="jenis_kendala" rows="3"
                                                                placeholder="Deskripsikan kendala yang dialami">{{ $d->jenis_kendala }}</textarea>
                                                        </div>
