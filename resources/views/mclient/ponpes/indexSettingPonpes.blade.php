                ...
                <div class="row py-3 align-items-center">
                    <div class="col d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-center align-items-center gap-12">
                            ...
                            <h1 class="headline-large-32 mb-0">Setting Monitoring Client Ponpes</h1>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        @if (request('table_search'))
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    <a href="{{ route('ListDataMclientPonpesSetting') }}" class="btn btn-sm btn-secondary ml-2">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center align-items-center">
                                                            ...
                                                            <label>Apakah Data Setting <b>{{ $d->nama_ponpes }} ({{ $d->formatted_jenis_layanan }})</b> ingin dihapus?</label>
                                                        </div>
                                                        <div class="modal-footer flex-row-reverse justify-content-between">
                                                            <button type="button" class="btn-cancel-modal" data-dismiss="modal">Tutup</button>
                                                            <form action="{{ route('MclientPonpesSettingDestroy', $d->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
                        ...
                        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                            <form action="{{ route('MclientPonpesSettingStore') }}" method="POST">
                                @csrf
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <label class="modal-title" id="addModalLabel">Tambah Data Setting Ponpes</label>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-4">
                                                <div class="mb-3 border-bottom pb-2 d-flex justify-content-center">
                                                    <label class="fw-bold">Detail Setting</label>
                                                </div>
                                                
                                                <div class="mb-3">
                                                    <label for="keterangan" class="form-label">Keterangan</label>
                                                    <textarea class="form-control" id="keterangan" name="keterangan" rows="3" 
                                                    placeholder="Masukkan keterangan setting (opsional)"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                <div class="mb-3 border-bottom pb-2 d-flex justify-content-center">
                                                    <label class="fw-bold">Tanggal & Status</label>
                                                </div>
                        ...
                        @foreach ($data as $d)
                            <div class="modal fade" id="editModal{{ $d->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $d->id }}" aria-hidden="true">
                                <form id="editForm{{ $d->id }}" action="{{ route('MclientPonpesSettingUpdate', ['id' => $d->id]) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <label class="modal-title" id="editModalLabel{{ $d->id }}">Edit Data Setting Ponpes</label>
                                                <button type="button" class="btn-close-custom" data-bs-dismiss="modal" aria-label="Close">
                                                    <i class="bi bi-x"></i>
                                                </button>
                                            </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="tanggal_terlapor" class="form-label">Tanggal Terlapor</label>
                                                                <input type="date" class="form-control" id="tanggal_terlapor{{ $d->id }}" name="tanggal_terlapor"
