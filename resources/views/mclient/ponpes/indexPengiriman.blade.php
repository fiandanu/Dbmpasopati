                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($data as $d)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($d->tanggal_sampai)
                                                        {{-- Jika sudah sampai, tampilkan durasi final dalam hari saja --}}
                                                        <span class="Tipereguller">{{ $d->durasi_hari }} hari</span>
                                                    @else
                                                        {{-- Jika belum sampai, tampilkan durasi real-time --}}
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="column">
                                                    <div class="mb-3">
                                                        ...
                                                        <small class="form-text text-muted">Durasi akan dihitung otomatis
                                                            setelah data disimpan</small>
                                                    </div>
                                                </div>
                                                <div class="column">
                                                    <div class="mb-3">
