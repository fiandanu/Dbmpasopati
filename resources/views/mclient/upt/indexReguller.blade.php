...
@section('content')
                ...
                <div class="row py-3 align-items-center">
                    <div class="col d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-center align-items-center gap-12">
                            ...
                            <h1 class="headline-large-32 mb-0">Komplain Reguler</h1>
                        </div>
                                                ...
                                                <div class="d-flex flex-column gap-12">
                                                    ...
                                                    <div class="btn-searchbar column-search">
                                                        ...
                                                        <input type="text" id="search-detail-kendala"
                                                            name="search_detail_kendala"> placeholder="Search">
                                                    </div>
                                                </div>
                                            </th>
                                            <th class="text-center align-top">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center align-items-center">
                                                            ...
                                                            <label>Apakah Data Komplain <b> {{ $d->nama_upt }} </b> ingin
                                                                dihapus?</label>
                                                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="column">
                                                    <div class="mb-3">
                                                        <label for="upt_search" class="form-label">Nama UPT <span
                        ...
                        @foreach ($data as $d)
                            <div class="modal fade" id="editModal{{ $d->id }}" tabindex="-1"
                                ...
                                <form id="editForm{{ $d->id }}"
                                    action="{{ route('mcreguler.MclientRegullerUpdate', ['id' => $d->id]) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-dialog modal-lg">
    ...
    <script>
        ...
        // Select UPT option - KIRIM ID BUKAN NAMA
        ...
        window.updateKanwilEdit = function(uptId, recordId) {
            console.log('Updating Kanwil for record:', recordId, 'with UPT ID:', uptId);
