...
<body>
    ...
    <div class="card-container">
        <div class="card">
            <h3>Vtren</h3>
            <p class="subtitle">Layanan Vtren</p>
            <div class="total">{{ $VtrenWartelStats['total'] }} Data</div>
            <div class="legend-item">
    ...
    <div class="total-section">
        ...
        <div class="total-card">
            ...
            <div class="number">{{ number_format($totalPonpes) }}</div>
        </div>

        <div class="total-card">
            <h4>VPAS Extension</h4>
            <div class="number">{{ number_format($totalExtensionVtren) }}</div>
        </div>
