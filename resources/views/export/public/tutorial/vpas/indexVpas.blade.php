...
<body>
    <div class="header">
        <h1>{{ $title }}</h1>
        <p>Laporan Data Tutorial UPT VPAS</p>
    </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 50%;">Tutorial VPAS</th>
    ...
    @else
        <div class="no-data">
            <p>Tidak ada data Tutorial VPAS yang tersedia</p>
        </div>
    @endif

    <div class="footer">
        <p>Dokumen ini digenerate secara otomatis oleh sistem Tutorial UPT</p>
