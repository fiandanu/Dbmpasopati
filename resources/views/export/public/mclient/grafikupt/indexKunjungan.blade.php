...
<head>
    <meta charset="utf-8">
    <title>Laporan Grafik Kunjungan UPT</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="first-page">
        <div class="header">
            <h2>LAPORAN GRAFIK UPT PALING SERING DIKUNJUNGI</h2>
            <p class="period">
        ...
        <div style="text-align: center;">
            <div class="info">
                <strong>Tipe Grafik:</strong> Kunjungan UPT
            ...
            <div class="summary-box">
                ...
                <div class="summary-grid">
                    <div class="summary-row">
                        ...
                        <div class="summary-item">
                            <strong>Kunjungan UPT Terbanyak</strong>
