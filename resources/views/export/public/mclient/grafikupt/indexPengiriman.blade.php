...
<head>
    <meta charset="utf-8">
    <title>Laporan Grafik Pengiriman Alat UPT</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="first-page">
        <div class="header">
            <h2>LAPORAN GRAFIK  UPT PENGIRIMAN ALAT TERBANYAK</h2>
            <p class="period">
        ...
        <div style="text-align: center;">
            <div class="info">
                <strong>Tipe Grafik:</strong> Pengiriman Alat UPT
                <span class="info-divider">|</span>
                <strong>Tampilan:</strong> UPT
            </div>
        </div>
            ...
            <div class="summary-box">
                ...
                <div class="summary-grid">
                    <div class="summary-row">
                        ...
                        <div class="summary-item">
                            <strong>Pengiriman UPT Terbanyak</strong>
                            <div class="value" style="font-size: 13px;">{{ $data['summaryData']['topUpt'] }}</div>
                        </div>
                        <div class="summary-item">
    ...
    <div class="table-section">
        <div class="table-title">Data Detail UPT</div>
        <table>
            <thead>
                <tr>
                    <th style="width: 10%;">Ranking</th>
                    <th style="width: 60%;">Nama UPT</th>
                    <th style="width: 30%;">Jumlah Pengiriman</th>
                </tr>
            </thead>
            <tbody>
