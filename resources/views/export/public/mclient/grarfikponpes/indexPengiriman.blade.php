...
<head>
    <meta charset="utf-8">
    <title>Laporan Grafik Pengiriman Alat PONPES</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="first-page">
        <div class="header">
            <h2>LAPORAN GRAFIK  PONPES PENGIRIMAN ALAT TERBANYAK</h2>
            <p class="period">
        ...
        <div style="text-align: center;">
            <div class="info">
                <strong>Tipe Grafik:</strong> Pengiriman Alat PONPES
            ...
            <div class="summary-box">
                ...
                <div class="summary-grid">
                    <div class="summary-row">
                        ...
                        <div class="summary-item">
                            <strong>Pengiriman PONPES Terbanyak</strong>
