...
<head>
    <meta charset="utf-8">
    <title>Laporan Grafik Monitoring Client PONPES</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <!-- Header -->
    <div class="header">
        <h2>LAPORAN GRAFIK MONITORING CLIENT PONPES</h2>
        <p class="period">
    ...
    <div style="text-align: center;">
        <div class="info">
            ...
            @elseif($chartType === 'vtren-kendala')
                Jenis Kendala Vtren
        ...
        <div class="summary-box">
            ...
            <div class="summary-grid">
                <div class="summary-row">
                    @if($chartType === 'vtren-kendala' || $chartType === 'reguler-kendala')
