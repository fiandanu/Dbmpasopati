                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="border rounded p-3 h-100">
                                            ...
                                            <h4 class="mb-0 font-weight-bold">{{ number_format($totalExtensionReguler) }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <tr>
                                ...
                                <th class="text-center align-top">
                                    <div class="d-flex justify-content-center align-items-center flex-column gap-12">
                                        ...
                                        <div class="btn-searchbar column-search">
                                            <span><i class="fas fa-search"></i></span>
                                            <input type="text" id="search-status-wartel" name="search_status_wartel">
                                        </div>
                                    </div>
                                </th>
                            </tr>
                            ...
                            @forelse ($data as $d)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <span class="badge-prosses">{{ $uploadedFolders }}/{{ $totalFolders }} Terupload</span>
                                        @endif
                                    </td>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <form method="GET" class="d-flex align-items-center">
                            ...
                            @if (request('search_status_pks'))
                                <input type="hidden" name="search_status_pks" value="{{ request('search_status_pks') }}">
                            @endif
                            @if (request('search_status_spp'))
                                <input type="hidden" name="search_status_spp" value="{{ request('search_status_spp') }}">
                            @endif
                            ...
                            @if (request('search_status_wartel'))
                                <input type="hidden" name="search_status_wartel" value="{{ request('search_status_wartel') }}">
                            @endif
                            @if (request('search_tanggal_dari'))
                                <input type="hidden" name="search_tanggal_dari" value="{{ request('search_tanggal_dari') }}">
                            @endif
                            @if (request('search_tanggal_sampai'))
                                <input type="hidden" name="search_tanggal_sampai" value="{{ request('search_tanggal_sampai') }}">
                            @endif

                            <div class="d-flex align-items-center">
                                <select name="per_page" class="form-control form-control-sm pr-2" style="width: auto;" onchange="this.form.submit()">
