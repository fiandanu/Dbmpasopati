...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="d-flex gap-12 mb-3"></div>
    ...
    {{-- SEARCH BY KOLOM DAN DOWLOAD PDF --}}
    <script>
        $(document).ready(function() {
            ...
            // DOWNLOAD CSV DATA UPT KESELURUHAN
            ...
            // DOWNLOAD PDF DATA UPT KESELURUHAN
            ...
            window.downloadCardsPdf = function() {
                ...
                let form = document.createElement('form');
                form.method = 'GET';
                form.action = '{{ route('database.DbUpt.export.cards.pdf') }}';
                form.target = '_blank';
