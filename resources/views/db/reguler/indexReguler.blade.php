                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="no_extension" name="no_extension" rows="6" placeholder="Contoh:&#10;No Extension&#10;No Extension&#10;No Extension;">{{ $d->no_extension }}</textarea>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="extension_password" name="extension_password" rows="6" placeholder="Contoh:&#10;password&#10;password&#10;password">{{ $d->extension_password }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
