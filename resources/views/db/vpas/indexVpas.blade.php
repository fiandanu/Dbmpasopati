                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="pic_upt" name="pic_upt"
                                                                value="{{ $d->pic_upt}}">
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="status_wartel"
                                                                name="status_wartel" value="{{ $d->status_wartel}}">
                                                        </div>
                                                    </div>
