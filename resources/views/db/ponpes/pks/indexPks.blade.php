    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>List Data Ponpes PKS(Perjanjian Kerja Sama)</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title mt-2">Data Ponpes</h3>
                                <div class="card-tools">
                                    <form action="{{ route('ponpes.pks.ListDataPks') }}" method="GET">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p class="text-info"><small><i class="fas fa-info-circle"></i>
                                                                    Data Ponpes tidak akan dihapus, hanya file PDF
                                                                    saja.</small></p>
                                                        </div>
