...
@section('content')
                        ...
                        <table class="table table-hover text-nowrap" id="Table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-top">
                                        <div class="d-flex flex-column gap-12 text-center">
                                            <span>Tipe</span>
                                            <div class="btn-searchbar column-search">
                                                <span>
                                                    <i class="fas fa-search"></i>
                                    ...
                                    <div class="modal fade" id="uploadModal{{ $d->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <form action="{{ route('sppPonpes.uploadFilePDF', [$d->id, 1]) }}"
                                                                        ...
                                                                        <div class="pdf-folder-actions"
                                                                            ...
                                                                            @if ($hasFile)
                                                                                ...
                                                                                <div class="btn-group mb-3 gap-3"
                                                                                    role="group">
                                                                                    <a href="{{ route('sppPonpes.viewpdf', [$d->id, $i]) }}"
                                                                                        target="_blank"
                                                                                        class="view-btn-pdf"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body text-center align-items-center">
                                                        ...
                                                        <label>Apakah Folder <b> {{ $d->nama_ponpes }} </b>
                                                            ingin
                                                            dihapus?</label>
                                                    </div>
                                                    <div class="modal-footer flex-row-reverse justify-content-between">
                                                        ...
                                                        <form
                                                            action="{{ route('sppPonpes.deleteFilePDF', [$d->id, $i]) }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-body text-center align-items-center">
                                                    ...
                                                    <p class="headline-large-32">Anda Yakin?</p>
                                                    <!-- UBAH TEKS INI -->
                                                    <label>Apakah Data SPP <b>{{ $d->nama_ponpes }}</b> ingin
                                                        dihapus?</label>
                                                ...
                                                <div class="modal-footer flex-row-reverse justify-content-between">
                                                    <button type="button" class="btn-cancel-modal"
                                                        data-dismiss="modal">Batal</button>
                                                    <form action="{{ route('sppPonpes.DatabasePageDestroy', $d->id) }}"
                                                        method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn-delete">
    ...
    <script>
        function updateFolder(id, folder) {
            ...
            form.action = "{{ route('sppPonpes.uploadFilePDF', [':id', ':folder']) }}"
                .replace(':id', id)
    ...
    <script>
        $(document).ready(function() {
            ...
            window.downloadCsv = function() {
                ...
                form.method = 'GET';
                form.action = '{{ route('sppPonpes.export.csv') }}'; // Update route sesuai ponpes
                form.target = '_blank';
            ...
            window.downloadPdf = function() {
                ...
                let form = document.createElement('form');
                form.method = 'GET';
                form.action = '{{ route('sppPonpes.export.pdf') }}'; // Update route sesuai ponpes
                form.target = '_blank';
