...
Route::prefix('mclient-ponpes-pengiriman')->group(function () {
    ...
    Route::put('/update/{id}', [PengirimanController::class, 'MclientPonpesPengirimanUpdate'])->name('MclientPonpesPengirimanUpdate');
    Route::delete('/destroy/{id}', [PengirimanController::class, 'MclientPonpesPengirimanDestroy'])->name('MclientPonpesPengirimanDestroy');
