...
class UptController extends Controller
{
    ...
    public function ListDataUpt(Request $request)
    {
        ...
        return view('db.reguler.indexReguler', compact('data', 'providers'));
    }

    // Di method yang menampilkan halaman (misal index atau edit)
    public function index()
    {
        $data = User::all();
        $providers = Provider::all(); // Untuk dropdown

        return view('your-view', compact('data', 'providers'));
    }
