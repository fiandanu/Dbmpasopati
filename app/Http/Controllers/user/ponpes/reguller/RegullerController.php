    ...
    public function ListDataPonpesUpdate(Request $request, $id)
    {
        $validator = Validator::make(
            ...
            [
                ...
                'tarif_wartel' => 'nullable|integer|min:0',
            ...
            [
                ...
                'tarif_wartel.integer' => 'Tarif wartel harus berupa angka.',
