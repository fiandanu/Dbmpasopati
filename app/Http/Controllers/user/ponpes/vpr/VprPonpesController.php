...
namespace App\Http\Controllers\user\ponpes\vpr;
...
class VprPonpesController extends Controller
{
    public function ListDataVprPonpes(Request $request)
    {
        $query = Ponpes::query();

        $query->where('tipe', 'vtren/reguler');
        ...
        $vpns = Vpn::all();
        return view('db.ponpes.vpr.indexVpr', compact('data', 'providers', 'vpns'));
    }
