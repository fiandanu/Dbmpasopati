...
class VtrenController extends Controller
{
    ...
    public function exportPonpesCsv($id): StreamedResponse
    {
        ...
        $rows = [
            ...
            ['Jumlah Line Reguler Terpasang', $dataOpsional ? $dataOpsional->jumlah_line_reguler : ''],
            ...
            ['Tarif Wartel Reguler', $dataOpsional ? $dataOpsional->tarif_wartel_reguler : ''],
            ['Status Wartel', $dataOpsional ? ($dataOpsional->status_wartel ? 'Aktif' : 'Tidak Aktif') : ''],
            ['Akses Topup Pulsa', $dataOpsional ? ($dataOpsional->akses_topup_pulsa ? 'Ya' : 'Tidak') : ''],
            ['Password Topup', $dataOpsional ? $dataOpsional->password_topup : ''],
            ['Akses Download Rekaman', $dataOpsional ? ($dataOpsional->akses_download_rekaman ? 'Ya' : 'Tidak') : ''],
