...
class RegullerController extends Controller
{
    ...
    {
        $data = Reguller::all();
        return view('tutorial.upt.reguller', compact('data'))->with('title', 'Tutorial Reguller');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tutor_upt.ListDataSpp')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function DatabasePageDestroy($id)
    {
        try {
            ...
            $dataupt->delete();
            return redirect()->route('tutor_upt.ListDataSpp')->with('success', 'Data berhasil dihapus');
        } catch (\Exception $e) {
            return redirect()->route('tutor_upt.ListDataSpp')->with('error', 'Gagal menghapus data: ' . $e->getMessage());
        }
    }
