...
class SettingPonpes extends Model
{
    use HasFactory;

    protected $table = 'mclient_ponpes_setting';
    ...
    public function isVtrenOnly()
    {
        return strtolower($this->jenis_layanan ?? '') === 'vtren';
    }
    ...
    public function isVtrenReguler()
    {
        return strtolower($this->jenis_layanan ?? '') === 'vtrenreg';
    }
}